...
server <- function(input, output) {
  ...
  observeEvent(input$go,{
    ...
    data = read.csv("C:/Users/JAY/R-Project/House_Price_Prediction-main/new house data 2.csv")
    #When we press go process then this all process will run
    View(data)
    
    summary(data)
    str(data)
    
    #Some Value are NA so we convert in factor
    ...
    #to take area_type and location as Unique we applyed sapply function
